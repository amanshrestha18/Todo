...
import com.aman.todoapp.Utils.Utils;
import com.aman.todoapp.model.Priority;
import com.aman.todoapp.model.SharedViewModel;
import com.aman.todoapp.model.Task;
import com.aman.todoapp.model.TaskViewModel;
...
public class BottomSheetFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onResume() {
        super.onResume();
        if (sharedViewModel.getSelecetedItem().getValue() != null){
            isEdit = sharedViewModel.getisEdit();
            Task task = sharedViewModel.getSelecetedItem().getValue();
        ...
        saveButton.setOnClickListener(v -> {
            ...
            if (!TextUtils.isEmpty(task) && dueDate != null && priority != null){
                Task myTask = new Task(task, priority,
                        ...
                        false);
                if (isEdit){
                    Task updateTask = sharedViewModel.getSelecetedItem().getValue();
